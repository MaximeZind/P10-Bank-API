                ...
                !isOpen ?
                    ...
                    <form className={classes.name_change_form} onSubmit={handleSubmit}>
                        <div className={classes.inputs_wrapper}>
                            <input className={classes.name_change_input} type="text" id="firstName" name="firstName" defaultValue={firstName} />
                            <input className={classes.name_change_input} type="text" id="lastName" name="lastName" defaultValue={lastName} />
                        </div>
